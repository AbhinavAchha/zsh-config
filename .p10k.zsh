# Generated by Powerlevel10k configuration wizard on 2021-05-27 at 17:30 IST.
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_TODO_VISUAL_IDENTIFIER_EXPANSION='B'
  ...
  # Custom icon.
  # typeset -g POWERLEVEL9K_TIMEWARRIOR_VISUAL_IDENTIFIER_EXPANSION='B'
